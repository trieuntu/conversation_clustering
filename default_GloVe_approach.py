#@title Other approaches (using GluOn): GloVe
import os
...
glove_vi = nlp.embedding.create('glove', source='glove.6B.100d')# see more models: nlp.embedding.list_sources('FastText')
vocab.set_embedding(glove_vi)
